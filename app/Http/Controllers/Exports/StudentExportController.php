...
class StudentExportController extends VoyagerBaseController
{
...
//    dd($dataType->server_side);
  ...
  public function export(Request $request, $slug) {
    return Excel::download(new StudentExport($slug), 'danh-sach-sinh-vien-cap-bang.xlsx');
  }
}
