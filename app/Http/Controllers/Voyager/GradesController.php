...
class GradesController extends VoyagerBaseController
{
  public function index(Request $request)
  {
    ...
    $dataTypeContent = $dataTypeContent->unique('classroom_id');
  ...
  private function checkTeacherPermission() {
    if(Auth::user()->getRelation('role')->name == 'teacher') {
      return "teacher";
    }elseif(Auth::user()->getRelation('role')->name == 'admin') {
      return "admin";
    }
  }
